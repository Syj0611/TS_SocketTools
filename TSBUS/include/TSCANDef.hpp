...
extern "C" u32 tsapp_delete_cyclic_msg_can(const size_t ADeviceHandle, const PLibCAN AData); 
extern "C" u32 tsapp_delete_cyclic_msg_canfd(const size_t ADeviceHandle, const PLibCANFD AData);
...
extern "C" u32 tsfifo_clear_canfd_receive_buffers_t(const size_t ADeviceHandle, const s32 AIdxChn);
